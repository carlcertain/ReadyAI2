  ...
  <div>
        ...
        <div className="pt-20 pb-10 md:pt-24 md:pb-14">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold tracking-tight text-white">
              ...
              <span className="block text-xl sm:text-2xl mt-4 text-accent">
    ...
    <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="w-full text-left">
        {!articleName && (
          <div className="text-center">
            <h2 className="inline-block text-2xl sm:text-4xl text-gray-700 mb-12 mt-12 tracking-wide border-b-2 border-dotted border-gray-400 pb-2">
              Latest Posts
            </h2>
          </div>
        )}
        ...
        {/* List view */}
        {!articleName && (
          <ul className="text-lg sm:text-xl mb-20">
            {articles.map((article, idx) => (
              <li
                key={article.id}
                className={`p-6 sm:p-10 mb-10 ${
                  idx === 0 ? "shadow-lg rounded-lg mb-20" : ""
                }`}
              >
                {/* Badge row */}
                {idx === 0 && (
                ...
                <div className="flex flex-col sm:flex-row items-start sm:space-x-4 space-y-4 sm:space-y-0">
                  <img
                    src={article.imgURL}
                    alt={article.title}
                    className="w-full sm:w-40 h-40 sm:h-20 object-cover rounded"
                  />
                  <div>
                    <button
        ...
        {currArticle && (
          <>
            ...
            <h2 className="text-2xl sm:text-4xl text-gray-700 mb-10 sm:mb-16 text-center">
              {currArticle.title}
            </h2>

            <div className="flex flex-col min-h-screen text-base sm:text-lg leading-relaxed sm:leading-loose tracking-normal sm:tracking-wider">
              <img
                src={currArticle.imgURL}
                alt={currArticle.title}
                className="object-cover w-full h-48 sm:h-64 mb-4 rounded-lg mx-auto"
              />

              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-10 sm:mb-20">
                ...
                <a
                  ...
                  className="flex gap-2 text-sm md:text-base leading-none md:justify-end"
                >
                  <span>Share:</span>
